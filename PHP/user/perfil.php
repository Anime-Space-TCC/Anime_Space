...
<head>
    <meta charset="UTF-8">
    <title>Perfil - Animes Space</title>
                ...
                <div class="blocos">
                    ...
                    <div class="bloco avatar-section">
                        <div class="avatar-section">
                            <div class="avatar">
                                <img src="<?= '../uploads/' . basename($fotoPerfil) . '?t=' . time() ?>"
                                    alt="Foto de perfil">
                            </div>
                        ...
                        <div class="medalhas-section">
                            ...
                            <div class="medalhas">
                                <?php if ($quizzesPerfeitos >= 10): ?>
                                    <div class="medalha" title="Otaku Mestre — 10 quizzes perfeitos">🧠</div><?php endif; ?>
                                <?php if (count($favoritos) >= 10): ?>
                                    <div class="medalha" title="Colecionador — 20 animes favoritados">⭐</div><?php endif; ?>
                                <?php if (count($historicoAnimes) >= 10): ?>
                                    <div class="medalha" title="Maratonista — 50 episódios assistidos">🔥</div>
                                <?php endif; ?>
                                <?php if ($nivel >= 10): ?>
                                    <div class="medalha" title="Veterano — Chegou ao nível 10">🏆</div><?php endif; ?>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <?php if ($favoritos): ?>
                                <?php foreach ($favoritos as $f): ?>
                                    <a href="../../PHP/user/episodes.php?id=<?= $f['id'] ?>" class="card">
                                        <img src="../../img/<?= htmlspecialchars($f['capa']) ?>"
