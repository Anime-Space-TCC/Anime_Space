...
<body class="admin-cruds">
  <div class="admin-links">
    ...
    <form method="GET" class="admin-busca">
      <input type="text" name="buscarUsuario" placeholder="Buscar usuário..." value="<?= htmlspecialchars($_GET['buscarUsuario'] ?? '') ?>">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="user_delete.php?id=<?= $u['id'] ?>" class="admin-btn" onclick="return confirm('Excluir este usuário?')">Excluir</a>
          </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
